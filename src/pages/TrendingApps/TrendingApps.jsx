    ...
    return (
        <div>
            <div className="w-11/12 mx-auto px-4 py-20 text-center">
                <div className="">
                    <h1 className='lg:text-5xl md:text-4xl text-3xl font-bold'>Trending Apps</h1>
                    <p className='text-lg text-[#627382] mt-5 mb-10'>Explore All Trending Apps on the Market developed by us</p>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>

                    {
                        trendingApp.map(app => (<App key={app.id} app={app}></App>))
                    }
                </div>
